...
import '../apis/audio_recorder_controller.dart';
import '../apis/audio_stream_recorder.dart';

// max/min_pitch, voice_analysis 에 사용될 Provider 이름 변경 가능성 높음
// 파일 저장 x, 음정 탐지 o, 박지 분석 x
final audioPitchNoSaveProvider = StateNotifierProvider.autoDispose<AudioRecorderController, bool>((
  ref,
) {
...
final autoStartPitchStreamProvider = StreamProvider.autoDispose<PitchData>((ref) async* {
