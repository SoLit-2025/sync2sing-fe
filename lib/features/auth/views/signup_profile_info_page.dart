...
class _SignupProfileInfoPageState extends ConsumerState<SignupProfileInfoPage> {
  ...
  void initState() {
    ...
    _years = List.generate(DateTime.now().year - 1899, (index) => (1900 + index).toString());
  ...
  bool get isFormValid =>
      gender != null && birthYear != null && isNicknameValid && !_showYearPicker;
  ...
  Widget _buildGenderButton(String label, bool isSelected) {
    return InkWell(
      onTap: () {
        ...
        ref.read(birthInfoProvider.notifier).update((state) => state.copyWith(gender: label));
      },
      child: Container(
        width: 154.sp,
        height: 50.sp,
          ...
          child: Container(
            ...
            child: Text(
              ...
              style: AppTextStyles.body1Bold.copyWith(
                color: birthYear == null ? AppColors.grayscale4 : AppColors.grayscale1,
              ),
            ),
          ),
        ),
              ...
              children: [
                SizedBox(
                  ...
                  child: CupertinoPicker(
                    scrollController: FixedExtentScrollController(initialItem: _selectedYearIndex),
                    itemExtent: 40.h,
                ...
                CupertinoButton(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      ref
                          .read(birthInfoProvider.notifier)
                          .update((state) => state.copyWith(birthYear: _years[_selectedYearIndex]));
                    });
                  },
                ),
              ],
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: AppTextStyles.body1Bold.copyWith(color: AppColors.grayscale4),
          ...
          suffixIcon:
              nicknameValidationMsg == null
                  ...
                  : Icon(
                    ...
                    color: isNicknameValid ? AppColors.systemSuccess : AppColors.systemDanger,
                  ),
        ),
          ...
          nicknameValidationMsg != null
              ? Text(
                ...
                style: AppTextStyles.body6.copyWith(
                  color: isNicknameValid ? AppColors.systemSuccessText : AppColors.systemDangerText,
                ),
                textAlign: TextAlign.left,
              )
  ...
  Widget _buildConfirmButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text("확인", style: AppTextStyles.body1White, textAlign: TextAlign.center),
      ),
    );
  }
}
