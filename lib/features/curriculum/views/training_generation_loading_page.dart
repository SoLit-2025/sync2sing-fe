...
class TrainingGenerationLoadingPage extends ConsumerWidget {
  final CurriculumGenerationRequest curriculumCreateData = CurriculumGenerationRequest(
  ...
  // extra로 정보 전달 시::
  // final CurriculumCreateData curriculumCreateData;
  // const TrainingGenerationLoadingPage(this.curriculumCreateData, {super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // debugPrint("트레이닝 모드: ${curriculumCreateData.trainingMode.name}");
    debugPrint("request: ${curriculumCreateData.toUpperJson()}");
