...
class DuetTrainingSettingPage extends ConsumerStatefulWidget {
  const DuetTrainingSettingPage({super.key});

  @override
  ConsumerState<DuetTrainingSettingPage> createState() => _DuetTrainingSettingPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    final bool isSongSelected =
        (selectedSong.id != null &&
            ...
            selectedSong.partName != null &&
            selectedSong.partNumber != null);
      ...
      children: [
        ...
        Row(
          children: [
            ...
            SizedBox(width: 8.w),
            _buildPartNameChip(isSelected, selectedSong),
          ],
        ),
      ],
    );
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed:
            isFormValid
                ? () async {
                  ref.read(selectedDuetSongProvider.notifier).setTrainingDays(_selectedDays!);
                  final data = {
                    "song_id": ref.read(selectedDuetSongProvider).id,
                    "training_days": ref.read(selectedDuetSongProvider).trainingDays,
                    "host_user_part_number": ref.read(selectedDuetSongProvider).partNumber,
                  };
