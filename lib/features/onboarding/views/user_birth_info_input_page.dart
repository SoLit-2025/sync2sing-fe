...
import 'package:sync2sing/features/auth/logics/birth_info_provider.dart';
...
class _UserBirthInfoInputPageState extends ConsumerState<UserBirthInfoInputPage> {
  ...
  void _toggleYearPicker() {
    setState(() {
      ...
      _pickerTempIndex =
          _selectedYear != null ? _years.indexOf(_selectedYear!) : (_years.length - 21);
    });
  }
  ...
  void _confirmYear() {
    setState(() {
      ...
      ref
          ...
          .update((state) => state.copyWith(birthYear: _selectedYear));
    });
  }
                ...
                children: [
                  Center(
                    child: CupertinoButton(
                      onPressed: _isButtonActive ? _navigateToVoiceSamplePage : null,
                      ...
                      child: Container(
                        ...
                        alignment: Alignment.center,
                        decoration: BoxDecoration(
                          color: _isButtonActive ? AppColors.primaryPink : AppColors.grayscale5,
